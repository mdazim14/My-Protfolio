...
const Body1 = () => {
    return (
        <div className="p-5 d-flex bg-dark text-white justify-content-center">
            <div className="col-6 p-5 border-top border-bottom border-warning text-left">
                <h1>Hi! I'm</h1>
                <h1 className="text-warning">Md Azim Howlader</h1>
            ...
            <div className="col-6 p-5 border-bottom border-top border-warning">
