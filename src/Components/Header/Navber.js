...
const Navber = () => {
    return (
        <div>
            ...
            <Navbar className="fs-5 fw-bold text-warning" collapseOnSelect expand="lg" bg="dark">
                <Container>
                    <Navbar.Brand className="fs-3 text-info border-bottom border-warning" href="#home">[ MD AZIM ]</Navbar.Brand>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav ">
                        <Nav className="ms-auto fw-bold">
                            ...
                            <Nav className=" m-2 border-bottom border-warning p-2" href="#memes">Resume</Nav>
                        </Nav>
                    </Navbar.Collapse>
                </Container>
            </Navbar>
